namespace :fill do
  ...
  task data: :environment do
    ...
    user = User.new(name: 'Rails', email: 'test@socially.com', sex: 'female', password: 'password')
    user.skip_confirmation!
    user.save!
    puts 'Created test user with email=test@socially.com and password=password'
